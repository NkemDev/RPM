...
if(isset($_POST['submit'])){
  ...
  $id=$_GET['seid'];
  $obj->edit_session($_POST['sessioname1'] ,$id);
            ...
            <div class ="card-body">
                <form method ="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="Session" name="sessioname1" value="<?php echo $res->sessioname;?>"required>
                        </div>
                      </div>
