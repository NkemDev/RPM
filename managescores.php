...
$obj=new DbFunction();
$rs=$obj->showstudentscores();
$rs2=$obj->showstudentscores2();


if(isset($_GET['del'])){
	

    $obj->delstudentscores(intval($_GET['del']));
...
<?php 
    ...
    <tr class="odd gradeX">
        ...
        <td><?php echo ($res->creditunit);?></td>
        <td><?php echo ($res->classtype);?></td>
        <td><?php echo ($res->glevel);?></td>
        <td><?php echo ($res->semester);?></td>
        <td><?php echo ($res->score);?></td>
        <td><?php echo ($res->grade);?></td>
        <td><?php echo ($res->gradept);?></td>
        <td><?php echo ($res->remark);?></td>
      
         
        
        
         <td><a href="managescores.php?del=<?php echo htmlentities($res2->scid); ?>"> <i class="fas fa-cut"></i></td></a>
