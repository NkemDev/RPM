...
if(isset($_POST['submit'])){
  ...
  $id=$_GET['cid'];
  $obj->edit_course($_POST['courseName'],$_POST['courseCode'],$_POST['deptcode'],$_POST['creditUnit'],$_POST['classtype'],$_POST['gradeLevel'],$_POST['semester'], $id);
                ...
                <div class="card-body">
                  <form method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="CourseName" name="courseName" value= "<?php echo $res->courseName;?>">
                            </div>
                    </div>
                    <div class="form-group row">
                        <label for="CourseCode" class="col-sm-3 col-form-label">Course Code:</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="CourseCode" name="courseCode" value="<?php echo $res->courseCode;?>">
                            </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <option value ="">Select</option>
                              <?php while($res1=$rs1->fetch_object()){?>
                                <option VALUE="<?php echo htmlentities($res1->did);?>"><?php echo htmlentities($res1->deptcode);?></option>
                                <?php }?> 
                            </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="CreditUnit" class="col-sm-3 col-form-label">Credit Unit:</label>
                            <div class="col-sm-3">
